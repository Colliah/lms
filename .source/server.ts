...
export const docs = await create.docs(
  ...
  {},
  {
    "database-schema.mdx": __fd_glob_0,
    "implementation-plan.mdx": __fd_glob_1,
    "introduction.mdx": __fd_glob_2,
    "server-actions.mdx": __fd_glob_3,
    "service-layer.mdx": __fd_glob_4,
    "setup-guide.mdx": __fd_glob_5,
  },
);
